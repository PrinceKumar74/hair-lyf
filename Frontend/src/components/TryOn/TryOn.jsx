...
// Product data with image URLs and links
const products = [
  { 
    id: 1,
    name: "Curly Wave",
    image:  "https://hips.hearstapps.com/hmg-prod/images/absolute-collagen-hair-loss-growth-6765ac2e1fc15.jpg?crop=0.8328940432261466xw:1xh;center,top&resize=640:*",
...
const TryOn = () => {
  ...
  const handleProductRedirect = () => {
    const productLink = products[activeProductIndex]?.link;
    if (productLink) {
  ...
  const WebcamSection = () => (
    <div className="flex flex-col items-center gap-4">
      <div className="lg:w-82 lg:h-96 w-50 h-62 bg-gray-200 rounded-full border border-blue-300 flex items-center justify-center overflow-hidden shadow-inner">
        {cameraOn ? (
          <Webcam
            ref={webcamRef}
            screenshotFormat="image/jpeg"
        ...
        <div className="w-full max-w-xs">
          ...
          >
            {products.map((product) => (
              <div key={product.id} className="p-2 h-82">
                <img
                  src={product.image}
                  alt={product.name}
...
//   // Unified function to capture the image
//   const handleCapture = () => {
//     if (webcamRef.current) {
//       const imageSrc = webcamRef.current.getScreenshot();
//       if (imageSrc) {
//         console.log("Captured image: Success");
//         setCapturedImage(imageSrc);
//         setCameraOn(false); // Turn off webcam after capture
//       } else {
...
//   // Unified camera component for both mobile and desktop
//   const CameraComponent = () => (
//     <div className="w-82 h-96 max-w-md max-h-96 bg-gray-200 rounded-full border border-blue-300 flex items-center justify-center overflow-hidden shadow-inner">
//       {cameraOn ? (
//         <Webcam
//           audio={false}
//           ref={webcamRef}
...
//           alt="Captured"
//           className="w-full h-full object-cover rounded-full cursor-pointer"
//           onClick={() => openModal(capturedImage)}
//         />
//       ) : (
//         <span className="text-xl text-gray-600">3D Image</span>
//       )}
...
//       {!cameraOn && (
//         <button
//           className="bg-gradient-to-br from-blue-400 via-blue-200 to-purple-400 hover:from-purple-400 hover:via-blue-200 hover:to-blue-400 transition-all duration-1000 cursor-pointer text-white px-4 py-1 rounded-full shadow h-12"
//           onClick={() => {
//             setCameraOn(true);
//             setCapturedImage(null);
//           }}
...
//       {/* Desktop Layout */}
//       <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-3 gap-6 lg:gap-10 w-full max-w-7xl">
//         {/* Left Side Products */}
...
//       {/* Action Buttons */}
//       <div className="mt-10 flex flex-wrap items-center justify-center gap-4 md:gap-10">
//         <Camera
//           className="w-10 h-10 text-gray-800 cursor-pointer hover:text-sky-400"
//           onClick={() => {
//             setCameraOn(true);
...
//           style={{ opacity: capturedImage ? 1 : 0.6, cursor: capturedImage ? 'pointer' : 'not-allowed' }}
//         >
//           Submit
//         </button>
