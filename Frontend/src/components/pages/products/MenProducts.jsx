...
const MenProducts = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const menWithUrls = men.map((item) => ({
          ...item,
  ...
  // Redux-based add to cart function (matching ProductDetailPage logic)
  ...
  // Redux-based add to wishlist function (matching ProductDetailPage logic)
      ...
      <div className="bg-white shadow-sm border-b-4 border-orange-400">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-orange-600 mb-2">Men's Collection</h1>
            <p className="text-gray-600 text-lg">Discover premium grooming products crafted for men</p>
          </div>
        </div>
      </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-4 rounded-xl transition-colors duration-200 flex items-center justify-center gap-2"
                    >
