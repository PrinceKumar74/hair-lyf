      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center ">
          <div className="md:col-span-1 text-center md:text-left">
            <div style={{ backgroundColor: barColor, color: headingColor }} className="inline-block  px-4 lg:px-10 py-2 uppercase font-semibold text-xl lg:text-3xl tracking-wider  mx-auto md:mx-0">
            ...
            <Link to='/tryOn'>
              <button className="border border-gray-500 text-gray-800 px-8 py-2 md:px-36  md:py-3 rounded-lg transition-colors hover:bg-gray-200 text-base md:text-lg font-semibold">
                Try Now
              </button></Link>
            </div>
